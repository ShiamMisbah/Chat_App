...
const Conversation = ({conversation, emoji, lastIdx}) => {
  ...
  return (
    <div>
        <div className={ `flex gap-2 items-center hover:bg-sky-500 ${isSelected ? 'bg-sky-500' : ""} rounded p-2 cursor-pointer`}
...
//             <div className="flex flex-col flex-1">
//                 <div className="flex gap-3 justify-between">
//                     <p className='font-bold text-gray-200'>Muntaha Misbah</p>
